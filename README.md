...
| 🧩 [Unification and Conversions](Tables/MPC-Puzzle/mpc-puzzle.md) | How do I convert between 2-, 3-, and 4-party secret-sharing schemes (the MPC Puzzle)? | [MPC Puzzle](Tables/MPC-Puzzle/mpc-puzzle.md) | [MPC Puzzle](https://kuleuven-cosic.github.io/sok-ppml-mpc-frameworks/mpc-puzzle) |
