...
| GAZELLE\[^5]          | 2018 | ℤ₂^ℓ, ℤ₂ | ✘     | SH  | ✘      | ✘        | ✘             | f‑independent  | ✘      |      ✘      |       ✔       |        ✘        |      ✔      |   ✘   |
| ABY³\[^6]             | 2018 | ℤ₂^ℓ, ℤ₂ | ✘     | ✘   | SH/A   | ✘        | ✘             | f‑independent  | ✘      |      ✔      |       ✘       |        ✔        |      ✘      |   ✘   |
| SecureNN\[^7]         | 2018 | ℤ₂^ℓ     | 𝔽ₚ   | ✘   | SH/A   | ✘        | ✔             | ✘              | ✘      |      ✔      |       ✘       |        ✔        |      ✘      |   ✘   |
| ASTRA\[^8]            | 2019 | —        | —     | ✘   | SH/A/F | ✘        | —             | —              | —      |      ✔      |       ✘       |        —        |      —      |   —   |
...
| Falcon\[^15]          | 2020 | ℤ₂^ℓ     | 𝔽ₚ   | ✘   | SH/A   | ✘        | ✘             | f‑independent  | ✘      |      ✔      |       ✘       |        ✔        |      ✘      |   ✘   |
| BLAZE\[^16]           | 2020 | ℤ₂^ℓ, ℤ₂ | ✘     | ✘   | A/F    | ✘        | ✘             | f‑dependent    | ✘      |      ✔      |       ✘       |        ✔        |      ✘      |   ✘   |
| FLASH\[^17]           | 2020 | —        | —     | A/R | ✘      | ✘        | —             | —              | —      |      ✔      |       ✘       |        —        |      —      |   —   |
| SWIFT\[^18]           | 2020 | ℤ₂^ℓ, ℤ₂ | ✘     | R   | R      | ✘        | ✘             | f‑dependent    | ✘      |      ✔      |       ✘       |        ✔        |      ✘      |   ✘   |
| MediSC\[^19]          | 2021 | —        | —     | SH  | ✘      | ✘        | —             | —              | —      |      ✘      |       ✔       |        —        |      —      |   —   |
| COINN\[^20]           | 2021 | —        | —     | SH  | ✘      | ✘        | —             | —              | —      |      ✘      |       ✔       |        —        |      —      |   —   |
| Muse\[^21]            | 2021 | —        | —     | A^C | ✘      | ✘        | —             | —              | —      |      ✘      |       ✔       |        —        |      —      |   —   |
| AriaNN\[^22]          | 2021 | —        | —     | SH  | ✘      | ✘        | —             | —              | —      |      ✔      |       ✘       |        —        |      —      |   —   |
| SiRnn\[^23]           | 2021 | ℤ₂^ℓ, ℤ₂ | ✘     | SH  | ✘      | ✘        | ✔             | ✘              | ✘      |      ✔      |       ✘       |        ✔        |      ✘      |   ✘   |
| ABY2.0\[^24]          | 2021 | ℤ₂^ℓ, ℤ₂ | ✘     | SH  | ✘      | ✘        | ✘             | f‑dependent    | ✘      |      ✔      |       ✘       |        ✔        |      ✘      |   ✘   |
| Fantastic Four\[^25]  | 2021 | ℤ₂^ℓ, ℤ₂ | ✘     | ✘   | A/R    | ✔        | f‑independent | ✘              | ✔      |      ✘      |       ✔       |        ✘        |      ✘      |       |
| Tetrad\[^26]          | 2021 | —        | —     | ✘   | F/R    | ✘        | —             | —              | —      |      ✔      |       ✘       |        —        |      —      |   —   |
| SONIC\[^27]           | 2022 | —        | —     | SH  | ✘      | ✘        | —             | —              | —      |      ✔      |       ✘       |        —        |      —      |   —   |
| Sphinx\[^28]          | 2022 | —        | —     | SH  | ✘      | ✘        | —             | —              | —      |      ✘      |       ✔       |        —        |      —      |   —   |
| SIMC\[^29]            | 2022 | ✘        | 𝔽ₚ   | A^C | ✘      | ✘        | ✘             | f‑independent  | ✘      |      ✘      |       ✔       |        ✘        |      ✔      |   ✘   |
| Cheetah\[^30]         | 2022 | ℤ₂^ℓ, ℤ₂ | ✘     | SH  | ✘      | ✘        | ✔             | ✘              | ✘      |      ✘      |       ✔       |        ✘        |      ✘      |   ✔   |
| Iron\[^31]            | 2022 | —        | —     | SH  | ✘      | ✘        | —             | —              | —      |      ✘      |       ✔       |        —        |      —      |   —   |
| Pika\[^32]            | 2022 | —        | —     | A   | ✘      | ✘        | —             | —              | —      |      ✔      |       ✘       |        —        |      —      |   —   |
| SecFloat\[^33]        | 2022 | —        | —     | SH  | ✘      | ✘        | —             | —              | —      |      ✔      |       ✘       |        —        |      —      |   —   |
| Llama\[^34]           | 2022 | —        | —     | SH  | ✘      | ✘        | —             | —              | —      |      ✔      |       ✘       |        —        |      —      |   —   |
...
| Orca\[^41]            | 2023 | ℤ₂^ℓ     | ✘     | SH  | ✘      | ✘        | ✘             | ✘              | TTP    |      ✔      |       ✘       |        ✘        |      ✔      |   ✘   |
| FssNN\[^42]           | 2023 | —        | —     | SH  | ✘      | ✘        | —             | —              | —      |      ✔      |       ✘       |        —        |      —      |   —   |
| SIGMA\[^43]           | 2023 | —        | —     | SH  | ✘      | ✘        | —             | —              | —      |      ✔      |       ✘       |        —        |      —      |   —   |
| BOLT\[^44]            | 2023 | ℤ₂^ℓ     | ✘     | SH  | ✘      | ✘        | ✔             | ✘              | ✘      |      ✘      |       ✔       |        ✘        |      ✘      |   ✔   |
| Force\[^45]           | 2023 | ℤ₂^ℓ, ℤ₂ | ✘     | ✘   | SH     | ✘        | f‑independent | ✘              | ✔      |      ✘      |       ✔       |        ✘        |      ✘      |       |
| Fusion\[^46]          | 2023 | —        | —     | A^S | ✘      | ✘        | —             | —              | —      |      ✘      |       ✔       |        —        |      —      |   —   |
